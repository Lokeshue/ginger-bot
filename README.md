...
OpenAI API – LLM reasoning + tool calling
...
Enter service name (e.g., Netflix, Adobe)
...
Portfolio project for AI / Data / ML roles
...
Now push it (exact commands)
nano README.md
# paste the above content, save

git add README.md
git commit -m "Update README with agentic AI and subscription reminder system"
git push